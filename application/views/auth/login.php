...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('http://fonts.googleapis.com/css?family=Noto+Sans:400,700,400italic') ?>">
...
<body class="page-body login-page login-form-fall" data-url="http://neon.dev">
    ...
    <div class="login-form">
        <div class="login-content">
            <form method="post" role="form" id="formlogin" action="<?= base_url('auth'); ?>">
